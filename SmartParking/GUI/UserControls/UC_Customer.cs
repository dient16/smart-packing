...
namespace SmartParking.GUI.UserControls
{
    public partial class UC_Customer : UserControl
    {
        ...
        private void GetAllUser()
        {
            ...
            var List = HandleDataDB.Ins.GetAllUsers("3");
        ...
        private void Grid_Users_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                var result = MessageBox.Show("Bạn có chắc chắn muốn xóa khách hàng này này?", "Thông báo", MessageBoxButtons.OKCancel);
